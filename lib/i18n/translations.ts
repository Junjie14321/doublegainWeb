export const translations = {
  en: {
    ...
    brandStory: {
      badge: 'Our story',
      title: 'A flavour story worth sharing',
      p1: 'Since 1996, Master 2 Foods has been bringing authentic Asian flavours closer to kitchens across Singapore. From carefully selected sauces and condiments to noodles and ready to cook ingredients, our range is made to help kitchens create great food with confidence, consistency, and ease.',
      p2: 'We work with the people who bring food to the table every day — from hawker centres and restaurants to hotels, caterers, and food businesses. Our ingredients are chosen not only for their flavour, but for the way they perform in the kitchen, batch after batch, service after service.',
      p3: 'From the depth of a rich Soya sauce to the familiar comfort of Yee Fu noodles, every ingredient has a purpose: to make cooking easier, flavours more authentic, and good food more effortless.',
      p4: "With reliable island-wide delivery, flexible ordering, and a dedicated team ready to help, we're here to be more than a supplier. We're here to bring the flavours you love, closer to the people who create them.",
    },
    values: {
    ...
    articles: {
      homeHeading: "What's the Secret Behind Great Dishes?",
      homeDescription: 'Discover authentic recipes, ingredient guides, and practical kitchen insights that help restaurants, caterers, and food businesses cook consistently, save time, and serve with confidence.',
  ...
  zh: {
    ...
    brandStory: {
      badge: '我们的故事',
      title: '值得分享的风味故事',
      p1: '自1996年起，Master 2 Foods持续将正宗亚洲风味带入新加坡各地厨房。从精心筛选的酱料与调味品，到面条及即煮食材，我们的产品系列旨在帮助厨房以自信、一致性与便利性烹制出美味佳肴。',
      p2: '我们与每天为餐桌准备食物的人携手合作——从小贩中心与餐厅，到酒店、餐饮公司及各类食品企业。我们的食材不仅以风味见长，更以在厨房中批次稳定、服务稳定的表现著称。',
      p3: '从浓郁酱油的醇厚，到伊府面的亲切口感，每一款食材都有其使命：让烹饪更轻松、风味更正宗、美食更唾手可得。',
      p4: '凭借可靠的全岛配送、灵活的订购方式，以及随时为您提供支持的专属团队，我们不仅是您的供应商，更是将您所喜爱的风味带给创造美食之人的伙伴。',
    },
    values: {
      title: '专为商业厨房打造',
      v1Title: '减少备料时间',
    ...
    articles: {
      homeHeading: '好菜的秘诀是什么？',
      homeDescription: '探索正宗食谱、食材指南与实用厨房知识，助力餐馆、外卖及食品企业稳定出品、节省时间、自信上菜。',
      getInspired: '获取灵感',
      readMore: '阅读更多',
      minRead: '分钟阅读',
    },
