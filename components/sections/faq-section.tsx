...
export function FAQSection() {
  ...
  return (
    <section style={{ backgroundColor: '#FFFEF8', paddingTop: '16px', paddingBottom: '33px' }}>
      <div className="container-pad">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 md:gap-16">
          {/* Left: header + category tabs */}
          <div className="md:col-span-2">
            ...
            <div className="w-10 h-0.5 bg-primary mt-4 mb-6" />
            ...
            {activeItems.map((faq, i) => (
              <div key={i} className="bg-white rounded-xl border border-border-color overflow-hidden">
                ...
                >
                  ...
                  <span className={`flex-shrink-0 w-5 h-5 rounded-full border border-border-color flex items-center justify-center transition-colors ${openIndex === i ? 'bg-primary border-primary' : 'bg-white'}`}>
                    <svg
